  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-xs text-gray-400">{methodDescription}</p>
        <div
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            ...
            className="rounded-lg border border-blue-500 bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white transition hover:border-blue-400 hover:bg-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/70"
